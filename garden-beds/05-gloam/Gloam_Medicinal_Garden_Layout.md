# The Gloam — Tomato Obelisk Circle

> **Location:** The Gloam (property entrance area)
> **Garden:** Obelisk circle with vertical tomato & pepper structures
> **Companion planting:** Basil, marigolds, borage, nasturtium
> **Related:** Medicinal herbs moved to **Potion Patch** (Wildwood)

**IMPORTANT:** North side = Front/Entry (visible from property entrance)

---

## Quick Reference: See Obelisk_Garden_Plan.md
...
- Companion planting: basil, marigolds, borage, nasturtium
- Full planting timeline from March through October
- Harvesting & pest management guide
- Sign installation at north edge (Dusty Purple + Silver)

---

## Related Gardens

**Potion Patch (Medicinal Herbs):**
- **Location:** Inside the Tomato Circle at Wildwood
- **Purpose:** Medicinal herbs with 3-phase planting strategy
- **See:** `gardening/beds/Potion_Patch.md`
...
- **Mulch:** Apply 2-3" around plants, 1" away from crowns
- **Water:** Soil-level watering, 1.5-2" per week
- **Companion planting:** Maximizes pollination, deters pests naturally
- **Harvest:** Begins mid-June, peaks July-September

---

**Ready to build your obelisk circle! See Obelisk_Garden_Plan.md for step-by-step instructions. 🌿✨**
